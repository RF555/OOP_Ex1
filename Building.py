    ...
    def __init__(self, jFile):
        ...
        try:
            ...
            for elev in data['_elevators']:
                tempElev = Elevator(elev['_id'],elev['_speed'],elev['_minFloor'],elev['_maxFloor'],elev['_closeTime'],elev['_openTime'],elev['_startTime'],elev['_stopTime'])
